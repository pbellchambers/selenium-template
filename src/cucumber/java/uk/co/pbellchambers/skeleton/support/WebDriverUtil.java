...
public class WebDriverUtil {
    ...
    public long waitTimeoutSeconds = 30;
    public long secondsForNotVisible = 5;
    ...
    private void moveToElement(WebElement element) {
        ...
        if(System.getProperty("isBrowserStackTest").equals("true") && System.getProperty("isMobileTest").equals("false")) {
            if(System.getProperty("browser").equals("Firefox") || System.getProperty("browser").equals("Chrome")) {
                actionMove(element);
            } else {
            ...
            if(System.getProperty("browserName").equals("android")) {
                actionMove(element);
            } else {
                javascriptMove(element);
            }
    ...
    private void javascriptMove(WebElement element) {
     ...
     * @param expectedValue pass the expected value of the attribute
     */
    public void waitForElementToNotContainAttribute(WebElement element, String attribute,
    ...
    public WebElement waitForAttributeToHaveValue(WebElement element, String attributeName, long timeoutSeconds, long pollingIntervalMs) {
        Predicate<WebDriver> condition = new ElementHasAttribute(element, attributeName);
        new WebDriverWait(driver, timeoutSeconds, pollingIntervalMs).until(condition);
        return element;
    }

    public WebElement waitForElementToBeVisible(final WebElement element, long timeoutSeconds, long pollingIntervalMs) {
        new WebDriverWait(driver, timeoutSeconds, pollingIntervalMs).until(new Predicate<WebDriver>() {
            @Override
